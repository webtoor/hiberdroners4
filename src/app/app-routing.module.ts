...
const routes: Routes = [
 {
  ...
  { path: 'modal-ikuti', loadChildren: './pages/modal-ikuti/modal-ikuti.module#ModalIkutiPageModule', canActivate : [AuthGuardService] },
  ...
  { path: 'filter-tawaran', loadChildren: './pages/filter-tawaran/filter-tawaran.module#FilterTawaranPageModule', canActivate : [AuthGuardService] },
